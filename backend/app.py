...
@app.route("/metroid_history")
def metroid_history():
    return render_template("metroid_history.html")

@app.route("/ff_history")
def ff_history():
    return render_template("ff_history.html")

@app.route("/pkmn_history")
def pkmn_history():
    return render_template("pkmn_history.html")

@app.route("/kirby_history")
def kirby_history():
    return render_template("kirby_history.html")

@app.route("/fzero_history")
def fzero_history():
    return render_template("fzero_history.html")

@app.route("/earthbound_history")
def earthbound_history():
    return render_template("earthbound_history.html")

@app.route("/dkc_history")
def dkc_history():
    return render_template("dkc_history.html")

@app.route("/starfox_history")
def starfox_history():
    return render_template("starfox_history.html")

@app.route("/warioland_history")
def warioland_history():
    return render_template("warioland_history.html")

@app.route("/megaman_history")
def megaman_history():
    return render_template("megaman_history.html")

@app.route("/megamanx_history")
def megamanx_history():
    return render_template("megamanx_history.html")
